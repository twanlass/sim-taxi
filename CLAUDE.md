...
| [docs/audio.md](docs/audio.md) | Music and effects: the event model, the mix as data, the sound lab at `/audio/`, the iOS audio session. The system is built; `src/audio/clips/` is still empty |
