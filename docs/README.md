...
| [rendering.md](rendering.md) | Low-poly technique, palette, camera, lighting, the day/night cycle, the island's faded edge, Crayon and Cartoon Mode, the bokeh glow, effects | `src/game/scene.js`, `src/geometry/` |
