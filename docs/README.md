...
A run opens with two speech bubbles from the taxi — "this car is you", then "tap that rider" — and
that is the whole tutorial; see [the opening tutorial](gameplay.md#the-opening-tutorial).
