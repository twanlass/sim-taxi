...
the separation with it. 22 points either way is what actually shows. Same for the resurfacing's
lightness jitter, which is ±0.055 rather than the ±0.028 it started at.
