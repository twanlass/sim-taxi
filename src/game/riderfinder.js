...
// ring around it is a CSS conic-gradient driven from game/urgency.js — the same scale as the
// diamond over the rider on the map and the ring that rides with the taxi, so all three read as
// one clock.
