...
const TUNING = {
  ...
  // 1.0 anyway, because `estimateSeconds` has a measured MAE of 3.3s against real trips (see
  ...
  // 1.0 even at the end of the ramp because `estimateSeconds` has a measured MAE of 3.3s against
